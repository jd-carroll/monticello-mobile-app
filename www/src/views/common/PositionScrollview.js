...
define(function(require, exports, module) {
    ...
    /**
     * PositionScrollview will lay out a collection of renderables sequentially in the specified direction, and will
     * allow you to scroll through them with mousewheel or touch events.
     * @class PositionScrollview
     * @constructor
     * @param {Options} [options] An object of configurable options.
     * @param {Number} [options.direction=Utility.Direction.Y] Using the direction helper found in the famous Utility
     * module, this option will lay out the PositionScrollview instance's renderables either horizontally
     * (x) or vertically (y). Utility's direction is essentially either zero (X) or one (Y), so feel free
     * to just use integers as well.
     * @param {Boolean} [options.rails=true] When true, PositionScrollview's genericSync will only process input in it's primary access.
     * @param {Number} [clipSize=undefined] The size of the area (in pixels) that PositionScrollview will display content in.
     * @param {Number} [margin=undefined] The size of the area (in pixels) that PositionScrollview will process renderables' associated calculations in.
     * @param {Number} [friction=0.001] Input resistance proportional to the velocity of the input.
     * Controls the feel of the PositionScrollview instance at low velocities.
     * @param {Number} [drag=0.0001] Input resistance proportional to the square of the velocity of the input.
     * Affects PositionScrollview instance more prominently at high velocities.
     ...
     * with hitting the end of a PositionScrollview.
     * @param {Number} [edgeDamp=1] Sets the damping on the spring that handles the physics associated
     * with hitting the end of a PositionScrollview.
     * @param {Boolean} [paginated=false] A paginated PositionScrollview will scroll through items discretely
     ...
     */
    function PositionScrollview(options) {
        // patch options with defaults
        this.options = Object.create(PositionScrollview.DEFAULT_OPTIONS);
    ...
    PositionScrollview.DEFAULT_OPTIONS = {
     ...
     */
    PositionScrollview.prototype.getCurrentIndex = function getCurrentIndex() {
        return this._node.index;
    };

    /**
     * goToPreviousPage paginates your PositionScrollview instance backwards by one item.
     *
     * @method goToPreviousPage
     * @return {ViewSequence} The previous node.
     */
    PositionScrollview.prototype.goToPreviousPage = function goToPreviousPage() {
    ...
    /**
     * goToNextPage paginates your PositionScrollview instance forwards by one item.
     *
     * @method goToNextPage
     * @return {ViewSequence} The next node.
     */
    PositionScrollview.prototype.goToNextPage = function goToNextPage() {
    ...
    /**
     * Paginates the PositionScrollview to an absolute page index.
     *
     * @method goToPage
     */
    PositionScrollview.prototype.goToPage = function goToPage(index) {
    ...
    PositionScrollview.prototype.outputFrom = function outputFrom() {
        return this._scroller.outputFrom.apply(this._scroller, arguments);
    };

    /**
     * Returns the position associated with the PositionScrollview instance's current node
     *  (generally the node currently at the top).
     *
     * @deprecated
     * @method getPosition
     * @param {number} [node] If specified, returns the position of the node at that index in the
     * PositionScrollview instance's currently managed collection.
     * @return {number} The position of either the specified node, or the PositionScrollview's current Node,
     * in pixels translated.
     */
    PositionScrollview.prototype.getPosition = function getPosition() {
        return this._particle.getPosition1D();
    };

    /**
     * Returns the absolute position associated with the PositionScrollview instance
     *
     * @method getAbsolutePosition
     * @return {number} The position of the PositionScrollview's current Node,
     * in pixels translated.
     */
    PositionScrollview.prototype.getAbsolutePosition = function getAbsolutePosition() {
        return this._scroller.getCumulativeSize(this.getCurrentIndex())[this.options.direction] + this.getPosition();
    };

    /**
     * Returns the offset associated with the PositionScrollview instance's current node
     *  (generally the node currently at the top).
     *
     * @method getOffset
     * @param {number} [node] If specified, returns the position of the node at that index in the
     ...
     * in pixels translated.
     */
    PositionScrollview.prototype.getOffset = PositionScrollview.prototype.getPosition;

    /**
     * Sets the position of the physics particle that controls PositionScrollview instance's "position"
     *
     * @deprecated
     * @method setPosition
     * @param {number} x The amount of pixels you want your PositionScrollview to progress by.
     */
    PositionScrollview.prototype.setPosition = function setPosition(x) {
        this._particle.setPosition1D(x);
    };

    /**
     * Sets the offset of the physics particle that controls PositionScrollview instance's "position"
     *
     * @method setPosition
     * @param {number} x The amount of pixels you want your PositionScrollview to progress by.
     */
    PositionScrollview.prototype.setOffset = PositionScrollview.prototype.setPosition;

    /**
     * Returns the PositionScrollview instance's velocity.
     *
     * @method getVelocity
     * @return {Number} The velocity.
     */

    PositionScrollview.prototype.getVelocity = function getVelocity() {
        return this._touchCount ? this._touchVelocity : this._particle.getVelocity1D();
    };

    /**
     * Sets the PositionScrollview instance's velocity. Until affected by input or another call of setVelocity
     *  the PositionScrollview instance will scroll at the passed-in velocity.
     *
     * @method setVelocity
     * @param {number} v The magnitude of the velocity.
     */
    PositionScrollview.prototype.setVelocity = function setVelocity(v) {
        this._particle.setVelocity1D(v);
    };

    /**
     * Patches the PositionScrollview instance's options with the passed-in ones.
     *
     * @method setOptions
     * @param {Options} options An object of configurable options for the PositionScrollview instance.
     */
    PositionScrollview.prototype.setOptions = function setOptions(options) {
    ...
    /**
     * Sets the collection of renderables under the PositionScrollview instance's control, by
     *  setting its current node to the passed in ViewSequence. If you
     *  pass in an array, the PositionScrollview instance will set its node as a ViewSequence instantiated with
     *  the passed-in array.
     *
     * @method sequenceFrom
     * @param {Array|ViewSequence} node Either an array of renderables or a Famous viewSequence.
     */
    PositionScrollview.prototype.sequenceFrom = function sequenceFrom(node) {
    ...
    /**
     * Returns the width and the height of the PositionScrollview instance.
     *
     * @method getSize
     * @return {Array} A two value array of the PositionScrollview instance's current width and height (in that order).
     */
    PositionScrollview.prototype.getSize = function getSize() {
     ...
     */
    PositionScrollview.prototype.render = function render() {
